...
import { Avatar, Badge, Button, ButtonGroup, Menu, MenuItem, Tooltip } from '@mui/material';
import { AccountCircle, Logout, PersonAdd, Settings } from '@mui/icons-material';
import { useTranslation } from 'react-i18next';
import './Home.css';
import PublicIcon from '@mui/icons-material/Public';
import { RU, UA, US } from 'country-flag-icons/react/3x2'
...
export default function HomeHeader(props: { main: any}) {
